...
export default class Game{
  ...
  /*spawn bullet in the canvas (from the starship)*/
  addBullet(){
...
/*terminate the game*/
  ...
  moveAndDraw(){
    ...
    this.bullets.forEach(
      ...
      /*filter saucers touch by bullet*/
      this.bullets.forEach(
        bullet => {
    ...
    /*requestAnimation is game isnt ended*/
    if(!this.end){
